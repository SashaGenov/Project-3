...
func (w Walking) Calories() float64 {
	// вставьте ваш код
	a := math.Pow((w.meanSpeed()*KmHInMsec), 2) / (w.Height / 100)
	b := CaloriesWeightMultiplier * w.Weight
	c := CaloriesSpeedHeightMultiplier * w.Weight
	return (b + a*c) * w.Duration.Minutes()
}
